...
const day6Data = {
    // 自定义日期显示
    customDateDisplay: '2026.1.11 第 6 天',
    // 跑马灯消息 - 每天可以不同
    marqueeMessages: [
        "甄贴心疗养院，为您服务！",
        "24小时皇家级医疗护理",  
    ...
    // 每日医嘱 - 每天完全不同
    dailyOrders: {
        '101': { type: '手术', medicine: "开颅手术"},
        '102':[ 
            { type: '口服', medicine: 'D药' },
            { type: '注射', medicine: '镇静剂' }
        ],
    ...
    settlementData: {
        // 第一行文本
        firstLine: '第6天的工作圆满完成',
        // 第二行文本（可选）
        secondLine:[
            "工作总结：我没有看到什么奇怪的现象，午饭是炖豆类配南瓜，味道偏甜，吃完有些口渴。" ,
            "尊重每位病人的病情变化，不要表现出明显的个人情绪"
        ],
        // 圆圈配置
        dots: [
            'white',
