...
const day12Data = {
    // 自定义日期显示
    customDateDisplay: '2026.1.17 第 12 天',
    // 跑马灯消息 - 每天可以不同
    marqueeMessages: [
        "甄贴心疗养院，为您服务！",
        "24小时皇家级医疗护理",  
    ...
    settlementData: {
        // 第一行文本
        firstLine: '第12天的工作圆满完成',
        // 第二行文本（可选）
        secondLine: [
            "工作总结：只剩下一位病人了，今日午餐是苹果炖猪排，肉质紧实口感丰满，真的太好吃了！",
            "昨天什么都没有发生，你不会生疑",
            '再坚持几天就结束了，我亲爱的孩子...',
        ],
        // 圆圈配置
    ...
    navigation: {
        ...
        goToNextDay: function(currentDay, nextDay, dayCommonInstance) { 
            window.location.href = `day13.html`;
