...
const day7Data = {
    // 自定义日期显示
    customDateDisplay: '2026.1.12 第 7 天',
    // 跑马灯消息 - 每天可以不同
    marqueeMessages: [
        "甄贴心疗养院，为您服务！",
        "24小时皇家级医疗护理",  
    ...
    dailyOrders: {
        ...
        '102':
            { type: '注射', medicine: ["■药","镇静剂"] },
        
        '202': { type: '注射', medicine: ['B药',"镇静剂"] }
    },
    // 添加图片配置
    patientImages: {
    ...
    settlementData: {
        // 第一行文本
        firstLine: '第7天的工作圆满完成',
        // 第二行文本（可选）
        secondLine: [
            "工作总结：已经有两位病人出院了诶，工作轻松很多了 午餐吃了红烧排骨，炖得很烂，几乎不需要怎么嚼。",
            "剩余病人：2，请勿在意病人出院去向"
        ],
        // 圆圈配置
        dots: [
    ...
    dischargeConfig: {
        '101': {
            ...
            needsCleaning: true,       // 第二个开关：是否需要整理病房
