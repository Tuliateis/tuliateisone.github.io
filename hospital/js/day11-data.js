...
const day11Data = {
    // 自定义日期显示
    customDateDisplay: '2026.1.16 第 11 天',
    // 跑马灯消息 - 每天可以不同
    marqueeMessages: [
        "快躲起来快躲起来快躲起来",
        "3————————————————",  
    ...
    settlementData: {
        // 第一行文本
        firstLine: '第11天的工作圆满完成',
        // 第二行文本（可选）
        secondLine: [
            "工作总结：一切都在往好的方向发展，午饭是清炒豆芽、胡萝卜和青椒，好饿...",
            "甄贴心疗养院是全市最好的疗养院，除此之外什么也不应该记得",
            "所有医嘱都是针对病人的治疗，请勿怀疑和崩溃"
        ],
        // 圆圈配置
        dots: [
            'white',
